...
function Checkout({CartItem}) {
  ...
  return (
    ...
    <h1 className='text-white mx-20 my-3 text-xl font-medium'>Checkout</h1>
<div className='container drop-shadow bg-white mx-auto mt-5 mb-24 align-center w-10/12 md:flow-root rounded-lg flex flex-col  justify-center border-2 border-slate-200'>
    <div className='md:flow-root md:mr-10 mt-4 mx-auto md:w-[9.5rem]'>
        <div className='md:float-right md:absolute'>
            <img className='w-11/12' src="" alt="cant show"/>
        </div>
    </div>
    ...
    <div className='w-10/12 mx-10 py-4'>
        <div className='flex md:justify-between w-full'>
            ...
            <input className='bg-gray-200 w-10/12 rounded-lg shadow-inner px-3 text-lg' type="text" name="checkoutaddress"  />
            {/* value={input.checkoutaddress} onChange={changeaddress} */}
        </div>
